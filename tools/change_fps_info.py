...
ori_videos_dir_path = 'data/mydata/test_video/newK_video/長時間需裁切'
output_videos_dir_path = 'data/mydata/test_video/newK_video/25fps/長時間需裁切'
...
for file_name in files:
    ...
    out = cv2.VideoWriter(os.path.join(output_videos_dir_path, video_name + '.avi'), fourcc, output_fps,
                        (1920, 1080))
