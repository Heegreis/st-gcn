...
from net.utils.st_gcn_encoder128 import Encoder
from net.utils.st_gcn_decoder128 import Decoder
    ...
    def forward(self, x, writer=None, current_iter=None):
        ...
        if writer != None and current_iter != None:
            if current_iter % 100 == 0:
                writer.add_image('128gcn256_img', make_grid(x[0].detach().cpu().unsqueeze(dim=1), nrow=16, padding=10, normalize=True, pad_value=1), current_iter)
